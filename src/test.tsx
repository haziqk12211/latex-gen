...
export default function App() {
  // NOTE: Page1 and Page3 don't exist yet — every step currently renders
  // Page2 so the app compiles and runs. Swap these back in once those
      ...
      <div className="flex">
        ...
        <main className="flex-1 px-8 py-10">
          ...
          <div className="max-w-3xl mx-auto">
            {/* Page1 and Page3 aren't built yet — Page2 renders for every step */}
            <Page2
              data={formData}
              update={updateForm}
