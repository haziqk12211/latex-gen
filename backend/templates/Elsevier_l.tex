...
%%     applies. Distinct from the free-text "Author Contributions" section above -
...
%% replace "+++" in the following lines with "elsarticle-harv" if referencing style is Harvard,
%% or with "elsarticle-num" for numbered.
%% If FormData.bibliographyname is non-empty, replace "..." with FormData.bibliographyname.
\bibliographystyle{+++}
\bibliography{...}
